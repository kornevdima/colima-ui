/**
 * In-memory ring buffer of CLI invocations (`lib/cli.js` hook) and Docker terminal launches
 * (`lib/terminal-launch.js` → `launchDockerInTerminal`). Optional broadcast when entries append.
 */
